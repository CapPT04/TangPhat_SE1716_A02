...
public partial class FunewsManagementSystemContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A2BB7B2EE78");
        ...
        {
            entity.HasKey(e => e.NewsArticleId).HasName("PK__NewsArti__4CD0926C9E748ED8");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.NewsArticles)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("NewsArticleId", "TagId").HasName("PK__NewsTag__9A875DC8DBB2A274");
                        j.ToTable("NewsTag");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA5866E660D48");

            entity.ToTable("SystemAccount");

            entity.HasIndex(e => e.AccountEmail, "UQ__SystemAc__FC770D3317B07D1D").IsUnique();
        ...
        {
            entity.HasKey(e => e.TagId).HasName("PK__Tag__657CFA4CBB73D48E");

            entity.ToTable("Tag");

            entity.HasIndex(e => e.TagName, "UQ__Tag__BDE0FD1D6886BBE0").IsUnique();
